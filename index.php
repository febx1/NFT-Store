                ...
                <div class="htc__product__container">
                    <div class="row">
                        <div class="product__list clearfix mt--30">
                            <?php $get_product=get_product($con,4);
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    ...
                                    <a href="product.php?id=<?php echo $list['nid']?>">
                                    ...
                                    <div class="fr__product__inner">
                                        <h4> <a href="product.php?id=<?php echo $list['nid']?>"><?php echo $list['name'] ?> </a></h4>
                                        <ul class="fr__pro__prize">
                                            <!-- <li class="old__prize"><?php //echo $list['descrip'] ?></li> -->
